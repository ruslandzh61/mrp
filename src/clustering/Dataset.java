...
public enum Dataset {
    ...
    WDBC("data/wdbc.csv", 0, true, true, 569, 30, 2, 1.0),
    FLAME("data/flame.csv", 0, false, true, 240, 2, 2), COMPOUND("data/compound.csv", 0, false, true, 399, 2, 6, 1.0),
    PATHBASED("data/pathbased.csv", 0, false, true, 300, 2, 3, 2.0), JAIN("data/jain.csv", 0, false, true, 373, 2, 2),
    S1("data/s1r5.csv", 0, false, false, 5000, 2, 15), S2("data/s2r5.csv", 0, false, false, 5000, 2, 15),
    DIM064("data/dim064.csv", 0, false, true, 1024, 64, 16), DIM256("data/dim256.csv", 0, false, true, 1024, 256, 16),
    S3("data/s3r5.csv", 0, false, false, 5000, 2, 15), S4("data/s4r5.csv", 0, false, false, 5000, 2, 15),
    ...
    Dataset(String aPath, int aHeader, boolean aRemoveFirst, boolean aNormalize, int aN, int aD, int aK, double aDist) {
        this.path = aPath;
        this.header = aHeader;
